...
export default class DataService {
  constructor() {
    ...
    this.downloadSelectionCountEndpoint =
      this.downloadSelectionEndpoint + "/count";
  ...
  async getDataSets() {
    return axios.get(
      this.dataEndpoint,
      this.userService.getTokenAuthorizationHeaderConfig()
    );
  }

  async getUserDataSets() {
    return axios.get(
      this.userDataEndpoint,
      this.userService.getTokenAuthorizationHeaderConfig()
    );
  }
  ...
  async downloadDataSet(id) {
    ...
    return axios
      .get(url, this.userService.getTokenAuthorizationHeaderConfig())
      .then(response => {
  ...
  async addData(bathymetryDataSetDTO, file) {
    bathymetryDataSetDTO.measurementDate = this.formatDate(
      bathymetryDataSetDTO.measurementDate
    );
    ...
    formData.append(
      "data",
      new Blob([JSON.stringify(bathymetryDataSetDTO)], {
